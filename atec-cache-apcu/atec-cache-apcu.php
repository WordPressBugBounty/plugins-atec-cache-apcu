...
if (INIT::is_real_admin())
{
	...
	if (defined('ATEC_OC_ACTIVE_APCU') && defined('ATEC_OC_VERSION') && ATEC_OC_VERSION!== '2.0.3')
	{
		require(__DIR__.'/includes/atec-wpca-install-object-cache.php');
