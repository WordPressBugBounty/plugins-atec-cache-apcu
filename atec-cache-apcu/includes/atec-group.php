...
private function atec_group_star_list()
{
	...
	<li>⭐ ', esc_attr__('Technical support','atec-cache-apcu'), '.</li>
...
<div class="atec-page">';
	...
	<div class="atec-main" style="padding-top: 30px;">';
				...
				<div class="atec-g atec-border atec-center" style="padding: 20px 10px;">
					...
					<div id="atec_group_pro_package">
						<div id="pro_package_welcome" class="atec-fit" style="margin: 0 auto;">
							<div class="atec-border-white atec-bg-w atec-fit" style="font-size: 16px !important; padding: 10px; text-align:left;">
								<ul class="atec-m-0">
								<li>⭐ <strong>', esc_attr__('25 valuable plugins','atec-cache-apcu'), '.</strong></li>';
								$this->atec_group_star_list();
							echo '
								</ul>
							</div>
		...
		echo '
		<div class="atec-g">';
		atec_table_header_tiny(['','Name (Link)','WP?',esc_attr__('Preview','atec-cache-apcu'),esc_attr__('Status','atec-cache-apcu'),esc_attr__('Description','atec-cache-apcu'),'#awards '.esc_attr__('PRO features','atec-cache-apcu')],'','atec-table-med');
