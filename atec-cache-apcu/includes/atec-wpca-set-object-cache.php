...
{ 
	...
	if (filter_var($options['ocache']??0,258)) { if (!$afs->copy(plugin_dir_path(__DIR__).'install/object-cache.php', $targetPath, true)) return 'Object-Cache installation failed'; }
	else
	{
