...
define('ATEC_APCU_OC_VERSION','1.0.9');
...
function wp_cache_add_multiple(array $data, $group = '', $expire = 0) { return WP_Object_Cache::instance()->add_multiple($data, $group, $expire); }
function wp_cache_set($key, $data, $group = '', $expire = 0) { return WP_Object_Cache::instance()->set($key, $data, $group, (int) $expire); }
function wp_cache_set_multiple(array $data, $group = '', $expire = 0) { return WP_Object_Cache::instance()->set_multiple($data, $group, $expire); }
...
function wp_cache_incr($key, $offset = 1, $group = '') { return WP_Object_Cache::instance()->incr($key, $offset, $group); }
function wp_cache_decr($key, $offset = 1, $group = '') { return WP_Object_Cache::instance()->incr($key, $offset * -1, $group); }
...
class WP_Object_Cache
{
    ...
    private function exists_np($key) { return isset($this->np_cache[$key]); }
